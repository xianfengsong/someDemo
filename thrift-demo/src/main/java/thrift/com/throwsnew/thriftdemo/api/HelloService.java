 ...
 */
package com.throwsnew.thriftdemo.api;
...
public class HelloService {
    ...
    public interface AsyncIface {
        ...
        public void helloString(String para, AsyncMethodCallback<AsyncClient.helloString_call> resultHandler)
                throws TException;

        public void helloInt(int para, AsyncMethodCallback<AsyncClient.helloInt_call> resultHandler) throws TException;

        public void helloBoolean(boolean para, AsyncMethodCallback<AsyncClient.helloBoolean_call> resultHandler)
                throws TException;

        public void helloVoid(AsyncMethodCallback<AsyncClient.helloVoid_call> resultHandler) throws TException;

        public void helloNull(AsyncMethodCallback<AsyncClient.helloNull_call> resultHandler) throws TException;
    ...
    public static class Client implements TServiceClient, Iface {
        ...
        public String recv_helloString() throws TException {
            ...
            if (msg.seqid != seqid_) {
                throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
                        "helloString failed: out of sequence response");
            }
        ...
        public int recv_helloInt() throws TException {
            ...
            if (msg.seqid != seqid_) {
                throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
                        "helloInt failed: out of sequence response");
            }
            ...
            throw new TApplicationException(TApplicationException.MISSING_RESULT, "helloInt failed: unknown result");
        }
        ...
        public boolean recv_helloBoolean() throws TException {
            ...
            if (msg.seqid != seqid_) {
                throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
                        "helloBoolean failed: out of sequence response");
            }
        ...
        public void recv_helloVoid() throws TException {
            ...
            if (msg.seqid != seqid_) {
                throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
                        "helloVoid failed: out of sequence response");
            }
        ...
        public String recv_helloNull() throws TException {
            ...
            if (msg.seqid != seqid_) {
                throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID,
                        "helloNull failed: out of sequence response");
            }
            ...
            throw new TApplicationException(TApplicationException.MISSING_RESULT, "helloNull failed: unknown result");
        }
    ...
    public static class AsyncClient extends TAsyncClient implements AsyncIface {
        ...
        public void helloInt(int para, AsyncMethodCallback<helloInt_call> resultHandler) throws TException {
            checkReady();
            helloInt_call method_call = new helloInt_call(para, resultHandler, this, protocolFactory, transport);
            manager.call(method_call);
        }

        public void helloBoolean(boolean para, AsyncMethodCallback<helloBoolean_call> resultHandler) throws TException {
            checkReady();
            helloBoolean_call method_call = new helloBoolean_call(para, resultHandler, this, protocolFactory,
                    transport);
            manager.call(method_call);
        }

        public void helloVoid(AsyncMethodCallback<helloVoid_call> resultHandler) throws TException {
            checkReady();
            helloVoid_call method_call = new helloVoid_call(resultHandler, this, protocolFactory, transport);
            manager.call(method_call);
        }

        public void helloNull(AsyncMethodCallback<helloNull_call> resultHandler) throws TException {
            checkReady();
            helloNull_call method_call = new helloNull_call(resultHandler, this, protocolFactory, transport);
            manager.call(method_call);
        }
        ...
        public static class helloString_call extends TAsyncMethodCall {
            ...
            public helloString_call(String para, AsyncMethodCallback<helloString_call> resultHandler,
        ...
        public static class helloInt_call extends TAsyncMethodCall {

            private int para;

            public helloInt_call(int para, AsyncMethodCallback<helloInt_call> resultHandler, TAsyncClient client,
            ...
            public void write_args(TProtocol prot) throws TException {
                prot.writeMessageBegin(new TMessage("helloInt", TMessageType.CALL, 0));
                helloInt_args args = new helloInt_args();
                args.setPara(para);
                args.write(prot);
                prot.writeMessageEnd();
        ...
        public static class helloBoolean_call extends TAsyncMethodCall {

            private boolean para;

            public helloBoolean_call(boolean para, AsyncMethodCallback<helloBoolean_call> resultHandler,
                    TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport)
                    throws TException {
                super(client, protocolFactory, transport, resultHandler, false);
                this.para = para;
            ...
            public void write_args(TProtocol prot) throws TException {
                prot.writeMessageBegin(new TMessage("helloBoolean", TMessageType.CALL, 0));
                helloBoolean_args args = new helloBoolean_args();
                args.setPara(para);
                args.write(prot);
                prot.writeMessageEnd();
        ...
        public static class helloVoid_call extends TAsyncMethodCall {

            public helloVoid_call(AsyncMethodCallback<helloVoid_call> resultHandler, TAsyncClient client,
                    TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
                super(client, protocolFactory, transport, resultHandler, false);
            }

            public void write_args(TProtocol prot) throws TException {
                prot.writeMessageBegin(new TMessage("helloVoid", TMessageType.CALL, 0));
                helloVoid_args args = new helloVoid_args();
                args.write(prot);
                prot.writeMessageEnd();
            }
        ...
        public static class helloNull_call extends TAsyncMethodCall {

            public helloNull_call(AsyncMethodCallback<helloNull_call> resultHandler, TAsyncClient client,
                    TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
                super(client, protocolFactory, transport, resultHandler, false);
            }

            public void write_args(TProtocol prot) throws TException {
                prot.writeMessageBegin(new TMessage("helloNull", TMessageType.CALL, 0));
                helloNull_args args = new helloNull_args();
                args.write(prot);
                prot.writeMessageEnd();
            }
    ...
    public static class Processor implements TProcessor {
        ...
        private class helloInt implements ProcessFunction {
        ...
        private class helloBoolean implements ProcessFunction {
        ...
        private class helloVoid implements ProcessFunction {
        ...
        private class helloNull implements ProcessFunction {
    ...
    public static class helloString_args implements TBase<helloString_args, helloString_args._Fields>,
    ...
    public static class helloString_result implements TBase<helloString_result, helloString_result._Fields>,
            java.io.Serializable, Cloneable {
    ...
    public static class helloInt_args implements TBase<helloInt_args, helloInt_args._Fields>, java.io.Serializable,
            Cloneable {

        public static final Map<_Fields, FieldMetaData> metaDataMap;
        private static final TStruct STRUCT_DESC = new TStruct("helloInt_args");
        private static final TField PARA_FIELD_DESC = new TField("para", TType.I32, (short) 1);
        // isset id assignments
        ...
        static {
            ...
            metaDataMap = Collections.unmodifiableMap(tmpMap);
            FieldMetaData.addStructMetaDataMap(helloInt_args.class, metaDataMap);
        }
    ...
    public static class helloInt_result implements TBase<helloInt_result, helloInt_result._Fields>,
            java.io.Serializable, Cloneable {

        public static final Map<_Fields, FieldMetaData> metaDataMap;
        private static final TStruct STRUCT_DESC = new TStruct("helloInt_result");
        ...
        static {
            ...
            tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT,
                    new FieldValueMetaData(TType.I32)));
            metaDataMap = Collections.unmodifiableMap(tmpMap);
            FieldMetaData.addStructMetaDataMap(helloInt_result.class, metaDataMap);
        }
    ...
    public static class helloBoolean_args implements TBase<helloBoolean_args, helloBoolean_args._Fields>,
            java.io.Serializable, Cloneable {

        public static final Map<_Fields, FieldMetaData> metaDataMap;
        private static final TStruct STRUCT_DESC = new TStruct("helloBoolean_args");
        private static final TField PARA_FIELD_DESC = new TField("para", TType.BOOL, (short) 1);
        // isset id assignments
        private static final int __PARA_ISSET_ID = 0;
        ...
        static {
            ...
            metaDataMap = Collections.unmodifiableMap(tmpMap);
            FieldMetaData.addStructMetaDataMap(helloBoolean_args.class, metaDataMap);
        }
    ...
    public static class helloBoolean_result implements TBase<helloBoolean_result, helloBoolean_result._Fields>,
            java.io.Serializable, Cloneable {

        public static final Map<_Fields, FieldMetaData> metaDataMap;
        private static final TStruct STRUCT_DESC = new TStruct("helloBoolean_result");
        ...
        static {
            ...
            tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT,
                    new FieldValueMetaData(TType.BOOL)));
            metaDataMap = Collections.unmodifiableMap(tmpMap);
            FieldMetaData.addStructMetaDataMap(helloBoolean_result.class, metaDataMap);
        }
    ...
    public static class helloVoid_args implements TBase<helloVoid_args, helloVoid_args._Fields>, java.io.Serializable,
            Cloneable {

        public static final Map<_Fields, FieldMetaData> metaDataMap;
        private static final TStruct STRUCT_DESC = new TStruct("helloVoid_args");

        static {
            Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
            metaDataMap = Collections.unmodifiableMap(tmpMap);
            FieldMetaData.addStructMetaDataMap(helloVoid_args.class, metaDataMap);
        }
    ...
    public static class helloVoid_result implements TBase<helloVoid_result, helloVoid_result._Fields>,
            java.io.Serializable, Cloneable {

        public static final Map<_Fields, FieldMetaData> metaDataMap;
        private static final TStruct STRUCT_DESC = new TStruct("helloVoid_result");

        static {
            Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
            metaDataMap = Collections.unmodifiableMap(tmpMap);
            FieldMetaData.addStructMetaDataMap(helloVoid_result.class, metaDataMap);
        }
    ...
    public static class helloNull_args implements TBase<helloNull_args, helloNull_args._Fields>, java.io.Serializable,
            Cloneable {

        public static final Map<_Fields, FieldMetaData> metaDataMap;
        private static final TStruct STRUCT_DESC = new TStruct("helloNull_args");

        static {
            Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
            metaDataMap = Collections.unmodifiableMap(tmpMap);
            FieldMetaData.addStructMetaDataMap(helloNull_args.class, metaDataMap);
        }
    ...
    public static class helloNull_result implements TBase<helloNull_result, helloNull_result._Fields>,
            java.io.Serializable, Cloneable {

        public static final Map<_Fields, FieldMetaData> metaDataMap;
        private static final TStruct STRUCT_DESC = new TStruct("helloNull_result");
        private static final TField SUCCESS_FIELD_DESC = new TField("success", TType.STRING, (short) 0);
        ...
        static {
            ...
            tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT,
                    new FieldValueMetaData(TType.STRING)));
            metaDataMap = Collections.unmodifiableMap(tmpMap);
            FieldMetaData.addStructMetaDataMap(helloNull_result.class, metaDataMap);
        }
